    ...
    <footer className="bg-primary text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-white/10 hover:bg-secondary rounded-full flex items-center justify-center transition-all duration-300"
          ...
          <div>
            <h4 className="font-display font-semibold text-lg mb-4 text-secondary uppercase tracking-wide">
              Link-uri Rapide
            </h4>
          ...
          <div>
            ...
            <form className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-sm text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-secondary transition-all duration-300"
              />
              <button
                type="submit"
                className="w-full bg-secondary hover:bg-secondary-dark text-white px-4 py-2 rounded-sm font-display text-sm uppercase tracking-wide transition-all duration-300"
              >
                Abonează-te
              </button>
            </form>
